...
var EditFormComponent = (function () {
    function EditFormComponent(movieService, router, route) {
    ...
    EditFormComponent.prototype.ngOnInit = function () {
        ...
        this.route
            ...
            if (selectedId) {
                _this.movieService
                    .getMovie(selectedId)
                    .subscribe(function (value) { return _this.model = value; }, function (error) { return _this.error = true; });
            }
            else {
                _this.resetModel();
            }
    ...
    EditFormComponent.prototype.onSubmit = function () {
        ...
        this.movieService
            ...
            if (isAdd) {
                ...
                _this.router.navigateByUrl('/details/'.concat(_this.model.id));
            }
        });
    };
